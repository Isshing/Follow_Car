...
CODE/Back_Wheel.obj: ../CODE/Back_Wheel.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	...
	"E:/Ti/ccs/tools/compiler/ti-cgt-msp430_20.2.5.LTS/bin/cl430" -vmspx --data_model=restricted -O2 --use_hw_mpy=F5 --include_path="E:/Ti/ccs/ccs_base/msp430/include" --include_path="E:/Ti/workspace/TJ" --include_path="E:/Ti/ccs/tools/compiler/ti-cgt-msp430_20.2.5.LTS/include" --advice:power=all --define=__MSP430F5529__ -g --printf_support=minimal --diag_warning=225 --diag_wrap=off --display_error_number --silicon_errata=CPU21 --silicon_errata=CPU22 --silicon_errata=CPU23 --silicon_errata=CPU40 --preproc_with_compile --preproc_dependency="CODE/$(basename $(<F)).d_raw" --obj_directory="CODE" $(GEN_OPTS__FLAG) "$<"
